            ...
            if (user == null && username.Contains("@"))
            {
                ...
                if (success)
                {
                    ...
                    var claims = new[]
                    {
                        ...
                        //create the response. This is an anonymous type; no need to create aspecial class to hold two props.
                        var jwt = new
                        {
                            access_token = encodedToken,
                            expiration = (int)TokenExpiration.TotalSeconds
                            };
                            httpContext.Response.ContentType = "application/json"; // this shouldlook familiar 
                            await
